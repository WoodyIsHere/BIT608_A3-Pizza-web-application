...
//return true; (commented out otherwise it would allow the user to view items from the database without being logged in.)
    ...
    if ($_SESSION['loggedin'] == 1)
       ...
       $_SESSION['URI'] = 'http://608.unaux.com/bit608_A3/pizza/'.$_SERVER['REQUEST_URI']; //save current url for redirect     
       header('Location: http://608.unaux.com/bit608_A3/pizza//login.php', true, 303);       
    }       
}
...
function login($id,$username) {
   ...
   if ($_SESSION['loggedin'] == 0 and !empty($_SESSION['URI']))        
     ...
     $_SESSION['URI'] =  'http://608.unaux.com/bit608_A3/pizza/listcustomers.php';         
     $uri = $_SESSION['URI'];           
   }  
